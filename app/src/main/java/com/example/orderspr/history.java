...
public class history extends AppCompatActivity {
    ...
    private void displayHistoryCreate(){
        ...
        FirebaseRecyclerAdapter<historyAdapter, history.ViewHolder> firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<historyAdapter, history.ViewHolder>(
                historyAdapter.class,
                R.layout.recycleview,
                history.ViewHolder.class,
                queryHistory)
        {
            @Override
            protected void populateViewHolder(history.ViewHolder viewHolder, final historyAdapter historyAdapter, int i) {
                ...
                viewHolder.hView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        Intent intent = new Intent(history.this, preview_request.class);
                ...
                viewHolder.hView.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        ...
                        MaterialAlertDialogBuilder aleBuilder = new MaterialAlertDialogBuilder(history.this,
