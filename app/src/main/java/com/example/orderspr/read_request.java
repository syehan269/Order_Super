...
public class read_request extends AppCompatActivity {
            ...
            public void onClick(View view) {
                if (CB_READ_SPR.isChecked()){
                    try {
                        ...
                        reference.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                databaseReference.child(fbkey).child("supervised").setValue(getName);
                            }
                        ...
                        Intent intent = new Intent(read_request.this, handle_list.class);
                        Toast.makeText(read_request.this, "Approved", Toast.LENGTH_SHORT).show();
                    ...
                    try {
                        ...
                        Intent intent = new Intent(read_request.this, handle_list.class);
                        Toast.makeText(read_request.this, "Canceled", Toast.LENGTH_SHORT).show();
                        startActivity(intent);
    ...
    private void showData() {
        ...
        queryRead_SPR.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(read_request.this, "ERROR: "+databaseError.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
